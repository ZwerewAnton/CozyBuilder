...
namespace Editor.SceneManagement
{
    ...
    public class SceneSwitcherPanel
    {
        ...
        private static void OnToolbarGUI()
        {
            ...
            if (GUILayout.Button(new GUIContent("Boot", "Start Scene Boot"))) GoToBootstrapScene();

            if (GUILayout.Button(new GUIContent("Menu", "Start Scene MainMenu"))) GoToMainMenuScene();

            if (GUILayout.Button(new GUIContent("Level", "Start Scene Level"))) GoToGameScene();
        }
